# Generated by Django 6.0 on 2026-01-14 17:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mmsi', models.CharField(max_length=20, null=True, unique=True)),
                ('imo_number', models.CharField(max_length=50, null=True)),
                ('name', models.CharField(max_length=255)),
                ('type', models.CharField(default='Unknown', max_length=100)),
                ('flag', models.CharField(default='Unknown', max_length=100)),
                ('cargo_type', models.CharField(max_length=100, null=True)),
                ('operator', models.CharField(default='Unknown Operator', max_length=255)),
